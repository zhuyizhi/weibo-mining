...
//	public static String CATEGORY = "sugar";
	public static int NGRAM_SIZE = 2;
	
	public static void trainModel(String sourceFile, String modelFile){
		try{
			BinaryLMClassifier classifier = 
				new BinaryLMClassifier(new NGramProcessLM(NGRAM_SIZE), 100);
//			BinaryLMClassifier classifier = 
//				new BinaryLMClassifier(new TokenizedLM(new IndoEuropeanTokenizerFactory(),
//						NGRAM_SIZE), 100);
	...
	public static void main(String[] args) throws Exception{
		...
		String name = "manual_garbage.txt";
		String name2 = "garbageFile_NoPOS.txt";
		String name3 = "garbageFile_NoPOS_NoBlank.txt";
		trainModel(path + name3, path + "classifier.model");
		
		String str1 = "给大家推荐一个热门话题！如果你也有兴趣，快来和我一起聊吧";
//		String str1 = "this is english";
...
//		String str4 = "给/p 大家/r 推荐/v 一个/mq 热门/a 话题/n ！/w 如果/c 你/r 也/d 有/v 兴趣/n ，/w 快/d 来/v 和/cc 我/r 一起/d 聊/v 吧/y ！/w ";
		String str3 = "要想查找数字，字母或数字，空白是很简单的，因为已经有了对应这些字符集合的元字符，但是如果你想匹配没有预定义元字符的字符集合(比如元音字母a,e,i,o,u),应该怎么办？";
//		String str2 = "don't choose this one";
		String str4 = "姜府呀局李双江之子打人毙叮统情人节康 我要减肥了起拘票喜";
		String str5 = "[爱你]★☆我朋友两个月痩了25斤～写了她的心得~超给力～需要的看看~>>>";
		...
		System.out.println(testModel(path + "classifier.model", str5));
	}
}
